...
l1_1 = Convolution(input_sizes=[args.batch_size, 64, 64, 1], filter_sizes=[3, 3, 1, 64], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv1")
...
l10_3 = Convolution(input_sizes=[args.batch_size, 64, 64, 64], filter_sizes=[3, 3, 64, 1], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv16")
l10_4 = BatchNorm(input_size=[args.batch_size, 64, 64, 1], name='conv16_bn')
# l10_5 = UpSample(input_shape=[args.batch_size, 64, 64, 3], ksize=2)
