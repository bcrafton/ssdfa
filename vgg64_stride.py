...
l1_3 = Relu()
l1_4 = Convolution(input_sizes=[batch_size, 64, 64, 64], filter_sizes=[3, 3, 64, 64], init=args.init, strides=[1, 2, 2, 1], padding="SAME", name="conv2")
l1_5 = BatchNorm(input_size=[args.batch_size, 64, 64, 64], name='conv2_bn')
l1_6 = Relu()
# l1_7 = AvgPool(size=[batch_size, 64, 64, 64], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")
...
l2_3 = Relu()
l2_4 = Convolution(input_sizes=[batch_size, 32, 32, 128], filter_sizes=[3, 3, 128, 128], init=args.init, strides=[1, 2, 2, 1], padding="SAME", name="conv4")
l2_5 = BatchNorm(input_size=[args.batch_size, 32, 32, 128], name='conv4_bn')
l2_6 = Relu()
# l2_7 = AvgPool(size=[batch_size, 32, 32, 128], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")
...
l3_3 = Relu()
l3_4 = Convolution(input_sizes=[batch_size, 16, 16, 256], filter_sizes=[3, 3, 256, 256], init=args.init, strides=[1, 2, 2, 1], padding="SAME", name="conv6")
l3_5 = Relu()
l3_6 = BatchNorm(input_size=[args.batch_size, 16, 16, 256], name='conv6_bn')
# l3_7 = AvgPool(size=[batch_size, 16, 16, 256], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")
...
l4_3 = Relu()
l4_4 = Convolution(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[3, 3, 512, 512], init=args.init, strides=[1, 2, 2, 1], padding="SAME", name="conv8")
l4_5 = Relu()
l4_6 = BatchNorm(input_size=[args.batch_size, 8, 8, 512], name='conv8_bn')
# l4_7 = AvgPool(size=[batch_size, 8, 8, 512], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")
