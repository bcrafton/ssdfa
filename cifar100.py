...
model = cifar_conv(batch_size=batch_size, dropout_rate=dropout_rate, num_classes=100)
# model = cifar_fc(batch_size=batch_size, dropout_rate=dropout_rate, num_classes=100)
