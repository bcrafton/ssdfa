...
l1_1 = Convolution(input_sizes=[batch_size, 64, 64, 3], filter_sizes=[3, 3, 3, 64], init=args.init, strides=[1, 1, 1, 1], padding="SAME", activation=Relu(), name="conv1", load=weights_conv, train=train_conv)
l1_2 = BatchNorm(input_size=[args.batch_size, 64, 64, 64], name='conv1_bn')
l1_4 = LELConv(input_shape=[args.batch_size, 64, 64, 64], filter_sizes=[3, 3, 64, 64], ksize=[1, 8, 8, 1], num_classes=1000, name='conv1_fb')
l1_5 = Convolution(input_sizes=[batch_size, 64, 64, 64], filter_sizes=[3, 3, 64, 64], init=args.init, strides=[1, 1, 1, 1], padding="SAME", activation=Relu(), name="conv2", load=weights_conv, train=train_conv)
l1_6 = BatchNorm(input_size=[args.batch_size, 64, 64, 64], name='conv2_bn')
l1_8 = LELConv(input_shape=[args.batch_size, 64, 64, 64], filter_sizes=[3, 3, 64, 64], ksize=[1, 8, 8, 1], num_classes=1000, name='conv2_fb')
l1_9 = AvgPool(size=[batch_size, 64, 64, 64], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")

l2_1 = Convolution(input_sizes=[batch_size, 32, 32, 64], filter_sizes=[3, 3, 64, 128], init=args.init, strides=[1, 1, 1, 1], padding="SAME", activation=Relu(), name="conv1", load=weights_conv, train=train_conv)
l2_2 = BatchNorm(input_size=[args.batch_size, 32, 32, 128], name='conv1_bn')
l2_4 = LELConv(input_shape=[args.batch_size, 32, 32, 128], filter_sizes=[3, 3, 128, 128], ksize=[1, 4, 4, 1], num_classes=1000, name='conv1_fb')
l2_5 = Convolution(input_sizes=[batch_size, 32, 32, 128], filter_sizes=[3, 3, 128, 128], init=args.init, strides=[1, 1, 1, 1], padding="SAME", activation=Relu(), name="conv2", load=weights_conv, train=train_conv)
l2_6 = BatchNorm(input_size=[args.batch_size, 32, 32, 128], name='conv2_bn')
l2_8 = LELConv(input_shape=[args.batch_size, 32, 32, 128], filter_sizes=[3, 3, 128, 128], ksize=[1, 4, 4, 1], num_classes=1000, name='conv2_fb')
l2_9 = AvgPool(size=[batch_size, 32, 32, 128], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")

l3_1 = Convolution(input_sizes=[batch_size, 16, 16, 128], filter_sizes=[3, 3, 128, 256], init=args.init, strides=[1, 1, 1, 1], padding="SAME", activation=Relu(), name="conv1", load=weights_conv, train=train_conv)
l3_2 = BatchNorm(input_size=[args.batch_size, 16, 16, 256], name='conv1_bn')
l3_4 = LELConv(input_shape=[args.batch_size, 16, 16, 256], filter_sizes=[3, 3, 256, 256], ksize=[1, 4, 4, 1], num_classes=1000, name='conv1_fb')
l3_5 = Convolution(input_sizes=[batch_size, 16, 16, 256], filter_sizes=[3, 3, 256, 256], init=args.init, strides=[1, 1, 1, 1], padding="SAME", activation=Relu(), name="conv2", load=weights_conv, train=train_conv)
l3_6 = BatchNorm(input_size=[args.batch_size, 16, 16, 256], name='conv2_bn')
l3_8 = LELConv(input_shape=[args.batch_size, 16, 16, 256], filter_sizes=[3, 3, 256, 256], ksize=[1, 4, 4, 1], num_classes=1000, name='conv2_fb')
l3_9 = AvgPool(size=[batch_size, 16, 16, 256], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")

l4_1 = Convolution(input_sizes=[batch_size, 8, 8, 256], filter_sizes=[3, 3, 256, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", activation=Relu(), name="conv1", load=weights_conv, train=train_conv)
l4_2 = BatchNorm(input_size=[args.batch_size, 8, 8, 512], name='conv1_bn')
l4_4 = LELConv(input_shape=[args.batch_size, 8, 8, 512], filter_sizes=[3, 3, 512, 512], ksize=[1, 2, 2, 1], num_classes=1000, name='conv1_fb')
l4_5 = Convolution(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[3, 3, 512, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", activation=Relu(), name="conv2", load=weights_conv, train=train_conv)
l4_6 = BatchNorm(input_size=[args.batch_size, 8, 8, 512], name='conv2_bn')
l4_8 = LELConv(input_shape=[args.batch_size, 8, 8, 512], filter_sizes=[3, 3, 512, 512], ksize=[1, 2, 2, 1], num_classes=1000, name='conv2_fb')
l4_9 = AvgPool(size=[batch_size, 8, 8, 512], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")
...
model = Model(layers=[                                          \
                      l1_1, l1_2, l1_4, l1_5, l1_6, l1_8, l1_9, \
                      l2_1, l2_2, l2_4, l2_5, l2_6, l2_8, l2_9, \
                      l3_1, l3_2, l3_4, l3_5, l3_6, l3_8, l3_9, \
                      l4_1, l4_2, l4_4, l4_5, l4_6, l4_8, l4_9, \
                      l5,                                       \
                      l8,                                       \
                      ])
