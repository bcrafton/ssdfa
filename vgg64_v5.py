...
l1_4 = LELConv(input_shape=[args.batch_size, 64, 64, 64], ksize=[1, 8, 8, 1], num_classes=1000, name='conv1_fb')
...
l1_8 = LELConv(input_shape=[args.batch_size, 64, 64, 64], ksize=[1, 8, 8, 1], num_classes=1000, name='conv2_fb')
...
l2_4 = LELConv(input_shape=[args.batch_size, 32, 32, 128], ksize=[1, 4, 4, 1], num_classes=1000, name='conv1_fb')
...
l2_8 = LELConv(input_shape=[args.batch_size, 32, 32, 128], ksize=[1, 4, 4, 1], num_classes=1000, name='conv2_fb')
...
l3_4 = LELConv(input_shape=[args.batch_size, 16, 16, 256], ksize=[1, 4, 4, 1], num_classes=1000, name='conv1_fb')
...
l3_8 = LELConv(input_shape=[args.batch_size, 16, 16, 256], ksize=[1, 4, 4, 1], num_classes=1000, name='conv2_fb')
...
l4_4 = LELConv(input_shape=[args.batch_size, 8, 8, 512], ksize=[1, 2, 2, 1], num_classes=1000, name='conv1_fb')
...
l4_8 = LELConv(input_shape=[args.batch_size, 8, 8, 512], ksize=[1, 2, 2, 1], num_classes=1000, name='conv2_fb')
