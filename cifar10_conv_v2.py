...
l7 = Relu()
l8 = LELConv(input_shape=[args.batch_size, 16, 16, 128], ksize=[1,4,4,1], num_classes=10, name='conv2_fb')
l9 = MaxPool(size=[args.batch_size, 16, 16, 128], ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding="SAME")

l10 = Convolution(input_sizes=[args.batch_size, 8, 8, 128], filter_sizes=[5, 5, 128, 256], init=args.init, strides=[1, 1, 1, 1], padding="SAME", bias=args.bias, name='conv3')
l11 = BatchNorm(input_size=[args.batch_size, 8, 8, 256], name='conv3_bn')
l12 = Relu()
l13 = LELConv(input_shape=[args.batch_size, 8, 8, 256], ksize=[1,2,2,1], num_classes=10, name='conv3_fb')
l14 = MaxPool(size=[args.batch_size, 8, 8, 256], ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding="SAME")
