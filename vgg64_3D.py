...
l0 = Convolution3D(input_sizes=[batch_size, 64, 64, 3], filter_sizes=[5, 5, 3, 1, 64], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv1", load=weights_conv, train=train_conv)
l1 = Convolution3D(input_sizes=[batch_size, 64, 64, 64], filter_sizes=[5, 5, 8, 8, 8], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l2 = MaxPool(size=[batch_size, 64, 64, 64], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")

l3 = Convolution3D(input_sizes=[batch_size, 32, 32, 64], filter_sizes=[5, 5, 8, 8, 16], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l4 = Convolution3D(input_sizes=[batch_size, 32, 32, 128], filter_sizes=[5, 5, 8, 16, 8], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv4", load=weights_conv, train=train_conv)
l5 = MaxPool(size=[batch_size, 32, 32, 128], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")

l6 = Convolution3D(input_sizes=[batch_size, 16, 16, 128], filter_sizes=[5, 5, 8, 16, 16], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv5", load=weights_conv, train=train_conv)
l7 = Convolution3D(input_sizes=[batch_size, 16, 16, 256], filter_sizes=[5, 5, 8, 32, 8], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv6", load=weights_conv, train=train_conv)
l8 = MaxPool(size=[batch_size, 16, 16, 256], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID")

l9 = Convolution3D(input_sizes=[batch_size, 8, 8, 256], filter_sizes=[5, 5, 8, 32, 16], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv7", load=weights_conv, train=train_conv)
l10 = Convolution3D(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[5, 5, 8, 64, 8], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv8", load=weights_conv, train=train_conv)
