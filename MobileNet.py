...
l0 = Convolution3D(input_sizes=[batch_size, 64, 64, 3], filter_sizes=[3, 3, 3, 1, 32], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv1", load=weights_conv, train=train_conv)

l1_1 = Convolution3D(input_sizes=[batch_size, 64, 64, 32], filter_sizes=[3, 3, 1, 32, 1], init=args.init, strides=[1, 2, 2, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l1_2 = BatchNorm(size=[32, 32, 32])
l1_3 = Convolution3D(input_sizes=[batch_size, 32, 32, 32], filter_sizes=[1, 1, 32, 1, 64], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l1_4 = BatchNorm(size=[32, 32, 64])

l2_1 = Convolution3D(input_sizes=[batch_size, 32, 32, 64], filter_sizes=[3, 3, 1, 64, 1], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l2_2 = BatchNorm(size=[32, 32, 64])
l2_3 = Convolution3D(input_sizes=[batch_size, 32, 32, 64], filter_sizes=[1, 1, 64, 1, 128], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l2_4 = BatchNorm(size=[32, 32, 128])

l3_1 = Convolution3D(input_sizes=[batch_size, 32, 32, 128], filter_sizes=[3, 3, 1, 128, 1], init=args.init, strides=[1, 2, 2, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l3_2 = BatchNorm(size=[16, 16, 128])
l3_3 = Convolution3D(input_sizes=[batch_size, 16, 16, 128], filter_sizes=[1, 1, 128, 1, 256], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l3_4 = BatchNorm(size=[16, 16, 256])

l4_1 = Convolution3D(input_sizes=[batch_size, 16, 16, 256], filter_sizes=[3, 3, 1, 256, 1], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l4_2 = BatchNorm(size=[16, 16, 256])
l4_3 = Convolution3D(input_sizes=[batch_size, 16, 16, 256], filter_sizes=[1, 1, 256, 1, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
