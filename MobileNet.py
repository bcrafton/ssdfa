...
l11 = Convolution3D(input_sizes=[batch_size, 64, 64, 32], filter_sizes=[3, 3, 1, 32, 1], init=args.init, strides=[1, 2, 2, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l12 = BatchNorm(size=[32, 32, 32])
l13 = Convolution3D(input_sizes=[batch_size, 32, 32, 32], filter_sizes=[1, 1, 32, 1, 64], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l14 = BatchNorm(size=[32, 32, 64])

l21 = Convolution3D(input_sizes=[batch_size, 32, 32, 64], filter_sizes=[3, 3, 1, 64, 1], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l22 = BatchNorm(size=[32, 32, 64])
l23 = Convolution3D(input_sizes=[batch_size, 32, 32, 64], filter_sizes=[1, 1, 64, 1, 128], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l24 = BatchNorm(size=[32, 32, 128])

l31 = Convolution3D(input_sizes=[batch_size, 32, 32, 128], filter_sizes=[3, 3, 1, 128, 1], init=args.init, strides=[1, 2, 2, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l32 = BatchNorm(size=[16, 16, 128])
l33 = Convolution3D(input_sizes=[batch_size, 16, 16, 128], filter_sizes=[1, 1, 128, 1, 256], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l34 = BatchNorm(size=[16, 16, 256])

l41 = Convolution3D(input_sizes=[batch_size, 16, 16, 256], filter_sizes=[3, 3, 1, 256, 1], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
