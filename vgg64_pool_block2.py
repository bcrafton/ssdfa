...
l1_1 = VGGBlock(input_shape=[args.batch_size, 64, 64, 3],   filter_shape=[3, 128],    strides=[1,1,1,1], init=args.init, pool_shape=[1,8,8,1], num_classes=1000, name='block1', ae_loss=args.ae_loss)
l1_2 = VGGBlock(input_shape=[args.batch_size, 64, 64, 128],  filter_shape=[128, 128],   strides=[1,1,1,1], init=args.init, pool_shape=[1,8,8,1], num_classes=1000, name='block2', ae_loss=args.ae_loss)
l1_3 = AvgPool(size=[args.batch_size, 64, 64, 128], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l2_1 = VGGBlock(input_shape=[args.batch_size, 32, 32, 128],  filter_shape=[128, 256],  strides=[1,1,1,1], init=args.init, pool_shape=[1,8,8,1], num_classes=1000, name='block3', ae_loss=args.ae_loss)
l2_2 = VGGBlock(input_shape=[args.batch_size, 32, 32, 256], filter_shape=[256, 256], strides=[1,1,1,1], init=args.init, pool_shape=[1,8,8,1], num_classes=1000, name='block4', ae_loss=args.ae_loss)
l2_3 = AvgPool(size=[args.batch_size, 32, 32, 256], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l3_1 = VGGBlock(input_shape=[args.batch_size, 16, 16, 256], filter_shape=[256, 512], strides=[1,1,1,1], init=args.init, pool_shape=[1,4,4,1], num_classes=1000, name='block5', ae_loss=args.ae_loss)
l3_2 = VGGBlock(input_shape=[args.batch_size, 16, 16, 512], filter_shape=[512, 512], strides=[1,1,1,1], init=args.init, pool_shape=[1,4,4,1], num_classes=1000, name='block6', ae_loss=args.ae_loss)
l3_3 = AvgPool(size=[args.batch_size, 16, 16, 512], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l4_1 = VGGBlock(input_shape=[args.batch_size, 8, 8, 512],   filter_shape=[512, 1024], strides=[1,1,1,1], init=args.init, pool_shape=[1,4,4,1], num_classes=1000, name='block7', ae_loss=args.ae_loss)
l4_2 = VGGBlock(input_shape=[args.batch_size, 8, 8, 1024],   filter_shape=[1024, 1024], strides=[1,1,1,1], init=args.init, pool_shape=[1,4,4,1], num_classes=1000, name='block8', ae_loss=args.ae_loss)
l4_3 = AvgPool(size=[args.batch_size, 8, 8, 1024], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l5_1 = VGGBlock(input_shape=[args.batch_size, 4, 4, 1024],   filter_shape=[1024, 2048],  strides=[1,1,1,1], init=args.init, pool_shape=[1,4,4,1], num_classes=1000, name='block9', ae_loss=args.ae_loss)
l5_2 = VGGBlock(input_shape=[args.batch_size, 4, 4, 2048],  filter_shape=[2048, 2048], strides=[1,1,1,1], init=args.init, pool_shape=[1,4,4,1], num_classes=1000, name='block10', ae_loss=args.ae_loss)
l5_3 = AvgPool(size=[args.batch_size, 4, 4, 2048], ksize=[1, 4, 4, 1], strides=[1, 4, 4, 1], padding="SAME")

l6 = ConvToFullyConnected(input_shape=[1, 1, 2048])
l7 = FullyConnected(input_shape=2048, size=1000, init=args.init, name="fc1")
