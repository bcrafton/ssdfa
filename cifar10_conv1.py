...
for ii in range(EPOCHS):
    ...
    for jj in range(int(TRAIN_EXAMPLES / BATCH_SIZE)):
        ...
        _correct, _, _gvs, (_forward, _backward) = sess.run([total_correct, train, grads_and_vars, backward], feed_dict={batch_size: BATCH_SIZE, dropout_rate: args.dropout, learning_rate: lr, X: xs, Y: ys})
