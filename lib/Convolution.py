...
class Convolution(Layer):
    ...
    def __init__(self, input_shape, filter_sizes, init, strides=[1,1,1,1], padding='SAME', alpha=0., activation=None, bias=0., use_bias=False, name=None, load=None, train=True):
