...
def VGGNet64(batch_size, dropout_rate, init='alexnet', sparse=0, fb_conv='f', fb_dw='f', fb_pw='f'):
    ...
    l1_2 = VGGBlock(input_shape=[batch_size, 64, 64, 64], filter_shape=[64, 64], init=init, name='block2', fb=fb_conv)
    ...
    l2_2 = VGGBlock(input_shape=[batch_size, 32, 32, 128], filter_shape=[128, 128], init=init, name='block4', fb=fb_conv)
    ...
    l3_2 = VGGBlock(input_shape=[batch_size, 16, 16, 256], filter_shape=[256, 256], init=init, name='block6', fb=fb_conv)
    ...
    l4_2 = VGGBlock(input_shape=[batch_size, 8, 8, 512],   filter_shape=[512, 512], init=init, name='block8', fb=fb_conv)
    ...
    l5_2 = VGGBlock(input_shape=[batch_size, 4, 4, 1024],  filter_shape=[1024, 1024], init=init, name='block10', fb=fb_conv)
