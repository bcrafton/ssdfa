...
def DenseNet64_L5(batch_size, dropout_rate, init='alexnet', fb='f_f', fb_dw='f_f', fb_pw='f_f'):
    ...
    l1 = ConvBlock(input_shape=[batch_size,64,64,6], filter_shape=[5,5,6,F], strides=[1,1,1,1], init=init, name='conv1', fb=fb)
...
def DenseNet64_L4(batch_size, dropout_rate, init='alexnet', fb='f_f', fb_dw='f_f', fb_pw='f_f'):
    ...
    l1 = ConvBlock(input_shape=[batch_size,64,64,6], filter_shape=[5,5,6,F], strides=[1,2,2,1], init=init, name='conv1', fb=fb)
