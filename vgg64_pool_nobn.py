...
l1_1 = Convolution(input_sizes=[batch_size, 64, 64, 3], filter_sizes=[3, 3, 3, 64], init=args.init, strides=[1, 1, 1, 1], padding="SAME", use_bias=True, name="conv1")
...
l1_5 = Convolution(input_sizes=[batch_size, 64, 64, 64], filter_sizes=[3, 3, 64, 64], init=args.init, strides=[1, 1, 1, 1], padding="SAME", use_bias=True, name="conv2")
...
l2_1 = Convolution(input_sizes=[batch_size, 32, 32, 64], filter_sizes=[3, 3, 64, 128], init=args.init, strides=[1, 1, 1, 1], padding="SAME", use_bias=True, name="conv3")
...
l2_5 = Convolution(input_sizes=[batch_size, 32, 32, 128], filter_sizes=[3, 3, 128, 128], init=args.init, strides=[1, 1, 1, 1], padding="SAME", use_bias=True, name="conv4")
...
l3_1 = Convolution(input_sizes=[batch_size, 16, 16, 128], filter_sizes=[3, 3, 128, 256], init=args.init, strides=[1, 1, 1, 1], padding="SAME", use_bias=True, name="conv5")
...
l3_5 = Convolution(input_sizes=[batch_size, 16, 16, 256], filter_sizes=[3, 3, 256, 256], init=args.init, strides=[1, 1, 1, 1], padding="SAME", use_bias=True, name="conv6")
...
l4_1 = Convolution(input_sizes=[batch_size, 8, 8, 256], filter_sizes=[3, 3, 256, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", use_bias=True, name="conv7")
...
l4_5 = Convolution(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[3, 3, 512, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", use_bias=True, name="conv8")
...
model = Model(layers=[                                          \
                      l1_1, l1_3, l1_4, l1_5, l1_7, l1_8, l1_9, \
                      l2_1, l2_3, l2_4, l2_5, l2_7, l2_8, l2_9, \
                      l3_1, l3_3, l3_4, l3_5, l3_7, l3_8, l3_9, \
                      l4_1, l4_3, l4_4, l4_5, l4_7, l4_8, l4_9, \
                      l5,                                       \
                      l6_1, l6_2,                               \
                      l7,                                       \
                      l8                                        \
