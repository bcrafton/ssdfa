...
l1_1 = Convolution(input_sizes=[batch_size, 64, 64, 1], filter_sizes=[3, 3, 1, 64], init=args.init, strides=[1, 1, 1, 1], padding="SAME", name="conv1")
l1_2 = BatchNorm(input_size=[args.batch_size, 64, 64, 64], name='conv1_bn')
l1_3 = Relu()
l1_4 = LELPool(input_shape=[args.batch_size, 64, 64, 64], pool_shape=[1, 8, 8, 1], num_classes=1000, dropout_rate=0.5, name='conv1_fb')
...
l1_7 = Relu()
l1_8 = LELPool(input_shape=[args.batch_size, 64, 64, 64], pool_shape=[1, 8, 8, 1], num_classes=1000, dropout_rate=0.5, name='conv2_fb')
...
l2_3 = Relu()
l2_4 = LELPool(input_shape=[args.batch_size, 32, 32, 128], pool_shape=[1, 4, 4, 1], num_classes=1000, dropout_rate=0.4, name='conv3_fb')
...
l2_7 = Relu()
l2_8 = LELPool(input_shape=[args.batch_size, 32, 32, 128], pool_shape=[1, 4, 4, 1], num_classes=1000, dropout_rate=0.4, name='conv4_fb')
...
l3_3 = Relu()
l3_4 = LELPool(input_shape=[args.batch_size, 16, 16, 256], pool_shape=[1, 4, 4, 1], num_classes=1000, dropout_rate=0.3, name='conv5_fb')
...
l3_7 = Relu()
l3_8 = LELPool(input_shape=[args.batch_size, 16, 16, 256], pool_shape=[1, 4, 4, 1], num_classes=1000, dropout_rate=0.3, name='conv6_fb')
...
l4_3 = Relu()
l4_4 = LELPool(input_shape=[args.batch_size, 8, 8, 512], pool_shape=[1, 2, 2, 1], num_classes=1000, dropout_rate=0.2, name='conv7_fb')
...
l4_7 = Relu()
l4_8 = LELPool(input_shape=[args.batch_size, 8, 8, 512], pool_shape=[1, 2, 2, 1], num_classes=1000, dropout_rate=0.2, name='conv8_fb')
