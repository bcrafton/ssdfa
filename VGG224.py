...
l1_1 = VGGBlock(input_shape=[batch_size, 224, 224, 3],   filter_shape=[3, 64],    strides=[1,1,1,1], init=args.init, name='block1')
l1_2 = VGGBlock(input_shape=[batch_size, 224, 224, 64],  filter_shape=[64, 64],   strides=[1,1,1,1], init=args.init, name='block2')
...
l7   = FullyConnected(input_shape=7*7*512, size=4096, init=args.init, name="fc1")
