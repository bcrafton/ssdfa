...
l1_3 = Relu()
l1_4 = LELPool(input_shape=[args.batch_size, 64, 64, 64], pool_shape=[1, 4, 4, 2], num_classes=1000, name='conv1_fb')
...
l2_3 = Relu()
l2_4 = LELPool(input_shape=[args.batch_size, 32, 32, 128], pool_shape=[1, 4, 4, 2], num_classes=1000, name='conv1_fb')
...
l4_8 = LELPool(input_shape=[args.batch_size, 4, 4, 512], pool_shape=[1, 1, 1, 32], num_classes=1000, name='conv2_fb')
