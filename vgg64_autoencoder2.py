...
l6_3 = UpSample(input_shape=[args.batch_size, 8, 8, 128], ksize=2)
...
l7_2 = Convolution(input_sizes=[args.batch_size, 16, 16, 128], filter_sizes=[3, 3, 128, 64], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv10")
l7_3 = UpSample(input_shape=[args.batch_size, 16, 16, 64], ksize=2)
...
l8_2 = Convolution(input_sizes=[args.batch_size, 32, 32, 64], filter_sizes=[3, 3, 64, 3], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv12")
l8_3 = UpSample(input_shape=[args.batch_size, 32, 32, 3], ksize=2)
