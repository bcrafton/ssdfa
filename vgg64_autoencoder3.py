...
l4_1 = ConvToFullyConnected(input_shape=[8, 8, 256])
l4_2 = FullyConnected(input_shape=8*8*256, size=4096, init=args.init, name="fc1")
l4_3 = Relu()
...
l6_2 = BatchNorm(input_size=[args.batch_size, 8, 8, 256], name='conv7_bn')
l6_3 = Convolution(input_sizes=[args.batch_size, 8, 8, 256], filter_sizes=[3, 3, 256, 128], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv8")
l6_4 = BatchNorm(input_size=[args.batch_size, 8, 8, 128], name='conv8_bn')
l6_5 = UpSample(input_shape=[args.batch_size, 8, 8, 128], ksize=2)

l7_1 = Convolution(input_sizes=[args.batch_size, 16, 16, 128], filter_sizes=[3, 3, 128, 128], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv9")
l7_2 = BatchNorm(input_size=[args.batch_size, 16, 16, 128], name='conv9_bn')
l7_3 = Convolution(input_sizes=[args.batch_size, 16, 16, 128], filter_sizes=[3, 3, 128, 64], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv10")
l7_4 = BatchNorm(input_size=[args.batch_size, 16, 16, 64], name='conv10_bn')
l7_5 = UpSample(input_shape=[args.batch_size, 16, 16, 64], ksize=2)

l8_1 = Convolution(input_sizes=[args.batch_size, 32, 32, 64], filter_sizes=[3, 3, 64, 64], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv11")
l8_2 = BatchNorm(input_size=[args.batch_size, 32, 32, 64], name='conv11_bn')
l8_3 = Convolution(input_sizes=[args.batch_size, 32, 32, 64], filter_sizes=[3, 3, 64, 3], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv12")
l8_4 = BatchNorm(input_size=[args.batch_size, 32, 32, 3], name='conv12_bn')
l8_5 = UpSample(input_shape=[args.batch_size, 32, 32, 3], ksize=2)
