...
l1_3 = Relu()
l1_4 = LELConv(input_shape=[args.batch_size, 64, 64, 64], ksize=[1, 4, 4, 1], num_classes=1000, name='conv1_fb')
...
l1_7 = Relu()
l1_8 = LELConv(input_shape=[args.batch_size, 64, 64, 64], ksize=[1, 4, 4, 1], num_classes=1000, name='conv2_fb')
...
l4_3 = Relu()
l4_4 = LELConv(input_shape=[args.batch_size, 8, 8, 512], ksize=[1, 4, 4, 1], num_classes=1000, name='conv1_fb')
