...
l0 = Convolution(input_sizes=[batch_size, 32, 32, 3], filter_sizes=[5, 5, 3, 96], init='sqrt_fan_in', strides=[1,2,2,1], padding="SAME", activation=Relu(), name='conv1')
l1 = LELConv(input_shape=[batch_size, 16, 16, 96], pool_shape=[1, 4, 4, 1], num_classes=10, name='conv1_fb')

l2 = Convolution(input_sizes=[batch_size, 16, 16, 96], filter_sizes=[5, 5, 96, 128], init='sqrt_fan_in', strides=[1,2,2,1], padding="SAME", activation=Relu(), name='conv2')
l3 = LELConv(input_shape=[batch_size, 8, 8, 128], pool_shape=[1, 2, 2, 1], num_classes=10, name='conv2_fb')

l4 = Convolution(input_sizes=[batch_size, 8, 8, 128], filter_sizes=[5, 5, 128, 256], init='sqrt_fan_in', strides=[1,2,2,1], padding="SAME", activation=Relu(), name='conv3')
l5 = LELConv(input_shape=[batch_size, 4, 4, 256], pool_shape=[1, 2, 2, 1], num_classes=10, name='conv3_fb')

l6 = ConvToFullyConnected(input_shape=[4, 4, 256])

l7 = FullyConnected(input_shape=4*4*256, size=10, init='sqrt_fan_in', name="fc1")
