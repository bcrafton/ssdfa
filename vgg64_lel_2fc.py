...
l1_3 = Relu()
l1_4 = LELPool(input_shape=[args.batch_size, 64, 64, 64], pool_shape=[1, 4, 4, 4], num_classes=1000, name='conv1_fb')
...
l1_7 = Relu()
l1_8 = LELPool(input_shape=[args.batch_size, 32, 32, 64], pool_shape=[1, 4, 4, 4], num_classes=1000, name='conv2_fb')
...
l2_3 = Relu()
l2_4 = LELPool(input_shape=[args.batch_size, 32, 32, 128], pool_shape=[1, 4, 4, 4], num_classes=1000, name='conv1_fb')
...
l2_7 = Relu()
l2_8 = LELPool(input_shape=[args.batch_size, 16, 16, 128], pool_shape=[1, 2, 2, 4], num_classes=1000, name='conv2_fb')
...
l3_3 = Relu()
l3_4 = LELPool(input_shape=[args.batch_size, 16, 16, 256], pool_shape=[1, 2, 2, 8], num_classes=1000, name='conv1_fb')
...
l3_8 = LELPool(input_shape=[args.batch_size, 8, 8, 256], pool_shape=[1, 2, 2, 8], num_classes=1000, name='conv2_fb')
...
l4_3 = Relu()
l4_4 = LELPool(input_shape=[args.batch_size, 8, 8, 512], pool_shape=[1, 2, 2, 16], num_classes=1000, name='conv1_fb')
...
l4_8 = LELPool(input_shape=[args.batch_size, 4, 4, 512], pool_shape=[1, 1, 1, 16], num_classes=1000, name='conv2_fb')
