...
l2_3 = Relu()
l2_4 = LELPool(input_shape=[args.batch_size, 32, 32, 128], pool_shape=[1, 4, 4, 1], num_classes=1000, name='conv1_fb')
...
l2_7 = Relu()
l2_8 = LELPool(input_shape=[args.batch_size, 16, 16, 128], pool_shape=[1, 4, 4, 1], num_classes=1000, name='conv2_fb')
...
l3_6 = BatchNorm(input_size=[args.batch_size, 8, 8, 256], name='conv6_bn')
l3_7 = Relu()
...
l4_3 = Relu()
l4_4 = LELPool(input_shape=[args.batch_size, 8, 8, 512], pool_shape=[1, 2, 2, 1], num_classes=1000, name='conv1_fb')
...
l4_6 = BatchNorm(input_size=[args.batch_size, 4, 4, 512], name='conv8_bn')
l4_7 = Relu()
l4_8 = LELPool(input_shape=[args.batch_size, 4, 4, 512], pool_shape=[1, 2, 2, 1], num_classes=1000, name='conv2_fb')
