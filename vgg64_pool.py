...
l2_7 = Relu()
l2_8 = LELPool(input_shape=[args.batch_size, 16, 16, 128], pool_shape=[1, 4, 4, 1], num_classes=1000, name='conv4_fb')
...
l3_7 = Relu()
l3_8 = LELPool(input_shape=[args.batch_size, 8, 8, 256], pool_shape=[1, 4, 4, 1], num_classes=1000, name='conv6_fb')
...
l4_7 = Relu()
l4_8 = LELPool(input_shape=[args.batch_size, 4, 4, 512], pool_shape=[1, 2, 2, 1], num_classes=1000, name='conv8_fb')
