...
np.savetxt('random_train.csv', weights['train_acc'], delimiter=',')
np.savetxt('random_test.csv', weights['test_acc'], delimiter=',')
...
plt.imsave("cifar10_conv_weights_random.png", img, cmap="gray", dpi=300)
