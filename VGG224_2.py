...
l1_1 = VGGBlock(input_shape=[batch_size, 224, 224, 3],  filter_shape=[3, 32],      strides=[1,1,1,1], pool_shape=[1,14,14,1], init=args.init, name='block1')
l1_2 = VGGBlock(input_shape=[batch_size, 224, 224, 32], filter_shape=[32, 32],     strides=[1,1,1,1], pool_shape=[1,14,14,1], init=args.init, name='block2')
l1_3 = AvgPool(size=[batch_size, 224, 224, 32], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l2_1 = VGGBlock(input_shape=[batch_size, 112, 112, 32], filter_shape=[32, 64],     strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block3')
l2_2 = VGGBlock(input_shape=[batch_size, 112, 112, 64], filter_shape=[64, 64],     strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block4')
l2_3 = AvgPool(size=[batch_size, 112, 112, 64], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l3_1 = VGGBlock(input_shape=[batch_size, 56, 56, 64],   filter_shape=[64, 128],    strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block5')
l3_2 = VGGBlock(input_shape=[batch_size, 56, 56, 128],  filter_shape=[128, 128],   strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block6')
l3_3 = VGGBlock(input_shape=[batch_size, 56, 56, 128],  filter_shape=[128, 128],   strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block7')
l3_4 = AvgPool(size=[batch_size, 56, 56, 128], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l4_1 = VGGBlock(input_shape=[batch_size, 28, 28, 128],  filter_shape=[128, 256],   strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block8')
l4_2 = VGGBlock(input_shape=[batch_size, 28, 28, 256],  filter_shape=[256, 256],   strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block9')
l4_3 = VGGBlock(input_shape=[batch_size, 28, 28, 256],  filter_shape=[256, 256],   strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block10')
l4_4 = AvgPool(size=[batch_size, 28, 28, 256], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l5_1 = VGGBlock(input_shape=[batch_size, 14, 14, 256],  filter_shape=[256, 512],   strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block11')
l5_2 = VGGBlock(input_shape=[batch_size, 14, 14, 512],  filter_shape=[512, 512],   strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block12')
l5_3 = VGGBlock(input_shape=[batch_size, 14, 14, 512],  filter_shape=[512, 512],   strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block13')
l5_4 = AvgPool(size=[batch_size, 14, 14, 512], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l6_1 = VGGBlock(input_shape=[batch_size, 7, 7, 512],    filter_shape=[512, 1024],  strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block14')
l6_2 = VGGBlock(input_shape=[batch_size, 7, 7, 1024],   filter_shape=[1024, 1024], strides=[1,1,1,1], pool_shape=[1,7,7,1], init=args.init, name='block15')
