...
l1_2 = VGGBlock(input_shape=[batch_size, 224, 224, 32], filter_shape=[32, 32],     strides=[1,1,1,1], init=args.init, name='block2')
l1_3 = AvgPool(size=[batch_size, 224, 224, 32], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l2_1 = VGGBlock(input_shape=[batch_size, 112, 112, 32], filter_shape=[32, 64],     strides=[1,1,1,1], init=args.init, name='block3')
l2_2 = VGGBlock(input_shape=[batch_size, 112, 112, 64], filter_shape=[64, 64],     strides=[1,1,1,1], init=args.init, name='block4')
l2_3 = AvgPool(size=[batch_size, 112, 112, 64], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l3_1 = VGGBlock(input_shape=[batch_size, 56, 56, 64],   filter_shape=[64, 128],    strides=[1,1,1,1], init=args.init, name='block5')
l3_2 = VGGBlock(input_shape=[batch_size, 56, 56, 128],  filter_shape=[128, 128],   strides=[1,1,1,1], init=args.init, name='block6')
l3_3 = VGGBlock(input_shape=[batch_size, 56, 56, 128],  filter_shape=[128, 128],   strides=[1,1,1,1], init=args.init, name='block7')
l3_4 = AvgPool(size=[batch_size, 56, 56, 128], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l4_1 = VGGBlock(input_shape=[batch_size, 28, 28, 128],  filter_shape=[128, 256],   strides=[1,1,1,1], init=args.init, name='block8')
l4_2 = VGGBlock(input_shape=[batch_size, 28, 28, 256],  filter_shape=[256, 256],   strides=[1,1,1,1], init=args.init, name='block9')
l4_3 = VGGBlock(input_shape=[batch_size, 28, 28, 256],  filter_shape=[256, 256],   strides=[1,1,1,1], init=args.init, name='block10')
l4_4 = AvgPool(size=[batch_size, 28, 28, 256], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")

l5_1 = VGGBlock(input_shape=[batch_size, 14, 14, 256],  filter_shape=[256, 512],   strides=[1,1,1,1], init=args.init, name='block11')
