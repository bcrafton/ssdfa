...
l1_1 = Convolution(input_sizes=[args.batch_size, 64, 64, 3], filter_sizes=[3, 3, 3, 64], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv1", load=weights_conv)
l1_2 = BatchNorm(input_size=[args.batch_size, 64, 64, 64], name='conv1_bn')
l1_3 = Relu()
l1_4 = Convolution(input_sizes=[args.batch_size, 64, 64, 64], filter_sizes=[3, 3, 64, 64], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv2", load=weights_conv)
...
l2_1 = Convolution(input_sizes=[args.batch_size, 32, 32, 64], filter_sizes=[3, 3, 64, 128], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv3", load=weights_conv)
l2_2 = BatchNorm(input_size=[args.batch_size, 32, 32, 128], name='conv3_bn')
l2_3 = Relu()
l2_4 = Convolution(input_sizes=[args.batch_size, 32, 32, 128], filter_sizes=[3, 3, 128, 128], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv4", load=weights_conv)
...
l3_1 = Convolution(input_sizes=[args.batch_size, 16, 16, 128], filter_sizes=[3, 3, 128, 256], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv5", load=weights_conv)
l3_2 = BatchNorm(input_size=[args.batch_size, 16, 16, 256], name='conv5_bn')
l3_3 = Relu()
l3_4 = Convolution(input_sizes=[args.batch_size, 16, 16, 256], filter_sizes=[3, 3, 256, 256], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv6", load=weights_conv)
...
l4_1 = Convolution(input_sizes=[args.batch_size, 8, 8, 256], filter_sizes=[3, 3, 256, 512], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv7", load=weights_conv)
l4_2 = BatchNorm(input_size=[args.batch_size, 8, 8, 512], name='conv7_bn')
l4_3 = Relu()
l4_4 = Convolution(input_sizes=[args.batch_size, 8, 8, 512], filter_sizes=[3, 3, 512, 512], init=args.init, strides=[1,1,1,1], padding="SAME", name="conv8", load=weights_conv)
