...
mnist_fc_bp = {'benchmark':'mnist_fc.py', 'epochs':300, 'batch_size':32, 'alpha':[0.1, 0.05, 0.03, 0.01], 'l2':[0.], 'eps':[1.], 'act':['relu', 'tanh'], 'bias':[0.0], 'dropout':[0.0], 'dfa':0, 'sparse':0, 'rank':0, 'init':'glorot_uniform', 'opt':'adam', 'load':None}
mnist_fc_dfa = {'benchmark':'mnist_fc.py', 'epochs':300, 'batch_size':32, 'alpha':[0.1, 0.05, 0.03, 0.01], 'l2':[0.], 'eps':[1.], 'act':['relu', 'tanh'], 'bias':[0.0], 'dropout':[0.0], 'dfa':1, 'sparse':0, 'rank':0, 'init':'zero', 'opt':'adam', 'load':None}
mnist_fc_sparse = {'benchmark':'mnist_fc.py', 'epochs':300, 'batch_size':32, 'alpha':[0.1, 0.05, 0.03, 0.01], 'l2':[0.], 'eps':[1.], 'act':['relu', 'tanh'], 'bias':[0.0], 'dropout':[0.0], 'dfa':1, 'sparse':1, 'rank':0, 'init':'zero', 'opt':'adam', 'load':None}
...
# cifar10_conv_dfa = {'benchmark':'cifar10_conv.py', 'epochs':300, 'batch_size':64, 'lr':[1e-6, 3e-6, 1e-5, 3e-5, 1e-4], 'eps':[1e-6, 3e-6, 1e-5, 3e-5, 1e-4], 'act':['relu'], 'bias':[0.1, 1.0], 'dropout':[0.25, 0.5], 'dfa':1, 'sparse':0, 'rank':0, 'init':'zero', 'load':None}
