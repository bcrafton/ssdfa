...
cifar10_conv_sparse = {'benchmark':'cifar10_conv.py', 'epochs':100, 'batch_size':64, 'lr':[1e-5, 3e-5, 1e-4], 'eps':[1e-5, 3e-5, 1e-4], 'act':['relu'], 'bias':[0.1], 'dropout':[0.5], 'dfa':1, 'sparse':1, 'rank':0, 'init':'zero', 'load':None}
