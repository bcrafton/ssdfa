...
imagenet = {'benchmark':'imagenet.py', 'epochs':2, 'batch_size':128, 'alpha':[1e-2], 'l2':[0.], 'eps':[1.], 'act':['relu'], 'bias':[0.], 'dropout':[0.5], 'dfa':0, 'sparse':0, 'rank':0, 'init':['alexnet'], 'opt':'adam', 'load':None}
