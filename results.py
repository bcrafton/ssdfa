...
vgg64 = {'benchmark':'vgg64_v3.py', 'epochs':100, 'batch_size':64, 'alpha':[0.02, 0.01], 'l2':[0.], 'eps':[1.], 'act':['relu'], 'bias':[0.], 'dropout':[0.5], 'dfa':0, 'sparse':0, 'rank':0, 'init':['alexnet'], 'opt':'adam', 'load':None}
