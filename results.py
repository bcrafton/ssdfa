...
vgg64_ae = {'benchmark':'vgg64_autoencoder5.py', 'epochs':10, 'batch_size':128, 'alpha':[0.1], 'l2':[0.], 'eps':[1.], 'act':['relu'], 'bias':[0.], 'dropout':[0.5], 'dfa':0, 'sparse':0, 'rank':0, 'init':['alexnet'], 'opt':'adam', 'load':['vgg64_bp.npy', 'vgg64_lel.npy']}

vgg64_ae_scratch = {'benchmark':'vgg64_autoencoder4.py', 'epochs':10, 'batch_size':128, 'alpha':[0.1], 'l2':[0.], 'eps':[1.], 'act':['relu'], 'bias':[0.], 'dropout':[0.5], 'dfa':0, 'sparse':0, 'rank':0, 'init':['alexnet'], 'opt':'adam', 'load':None}
