...
l4 = FullyConnected(size=[16*16*96, 16*16*96], num_classes=10, init_weights=args.init, alpha=learning_rate, activation=act, bias=args.bias, last_layer=False, name='fc1', load=weights_fc, train=train_fc)
l5 = Dropout(rate=dropout_rate)
l6 = FeedbackFC(size=[16*16*96, 16*16*96], num_classes=10, sparse=args.sparse, rank=args.rank, name='fc1_fb')

l7 = Convolution(input_sizes=[batch_size, 16, 16, 96], filter_sizes=[5, 5, 96, 128], num_classes=10, init_filters=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=act, bias=args.bias, last_layer=False, name='conv1', load=weights_conv, train=train_conv)
l8 = MaxPool(size=[batch_size, 16, 16, 128], ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding="SAME")
l9 = FeedbackConv(size=[batch_size, 8, 8, 128], num_classes=10, sparse=args.sparse, rank=args.rank, name='conv1_fb')
l10 = ConvToFullyConnected(shape=[8, 8, 128])
l11 = FullyConnected(size=[8*8*128, 8*8*128], num_classes=10, init_weights=args.init, alpha=learning_rate, activation=act, bias=args.bias, last_layer=False, name='fc1', load=weights_fc, train=train_fc)
l12 = Dropout(rate=dropout_rate)
l13 = FeedbackFC(size=[8*8*128, 8*8*128], num_classes=10, sparse=args.sparse, rank=args.rank, name='fc1_fb')

l14 = FullyConnected(size=[8*8*128, 10], num_classes=10, init_weights=args.init, alpha=learning_rate, activation=Linear(), bias=args.bias, last_layer=True, name='fc3', load=weights_fc, train=train_fc)
