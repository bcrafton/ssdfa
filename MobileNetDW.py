...
l2_1 = ConvolutionDW(input_sizes=[batch_size, 32, 32, 64], filter_sizes=[3, 3, 64, 1], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l2_2 = BatchNorm(size=[32, 32, 64])
l2_3 = Convolution2D(input_sizes=[batch_size, 32, 32, 64], filter_sizes=[1, 1, 64, 128], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l2_4 = BatchNorm(size=[32, 32, 128])

l3_1 = ConvolutionDW(input_sizes=[batch_size, 32, 32, 128], filter_sizes=[3, 3, 128, 1], init=args.init, strides=[1, 2, 2, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l3_2 = BatchNorm(size=[16, 16, 128])
l3_3 = Convolution2D(input_sizes=[batch_size, 16, 16, 128], filter_sizes=[1, 1, 128, 256], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l3_4 = BatchNorm(size=[16, 16, 256])

l4_1 = ConvolutionDW(input_sizes=[batch_size, 16, 16, 256], filter_sizes=[3, 3, 256, 1], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l4_2 = BatchNorm(size=[16, 16, 256])
l4_3 = Convolution2D(input_sizes=[batch_size, 16, 16, 256], filter_sizes=[1, 1, 256, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l4_4 = BatchNorm(size=[16, 16, 512])

l5_1 = ConvolutionDW(input_sizes=[batch_size, 16, 16, 512], filter_sizes=[3, 3, 512, 1], init=args.init, strides=[1, 2, 2, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l5_2 = BatchNorm(size=[8, 8, 512])
l5_3 = Convolution2D(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[1, 1, 512, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l5_4 = BatchNorm(size=[8, 8, 512])

l6_1 = ConvolutionDW(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[3, 3, 512, 1], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l6_2 = BatchNorm(size=[8, 8, 512])
l6_3 = Convolution2D(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[1, 1, 512, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l6_4 = BatchNorm(size=[8, 8, 512])

l7_1 = ConvolutionDW(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[3, 3, 512, 1], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l7_2 = BatchNorm(size=[8, 8, 512])
l7_3 = Convolution2D(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[1, 1, 512, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
l7_4 = BatchNorm(size=[8, 8, 512])

l8_1 = ConvolutionDW(input_sizes=[batch_size, 8, 8, 512], filter_sizes=[3, 3, 512, 1], init=args.init, strides=[1, 2, 2, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv2", load=weights_conv, train=train_conv)
l8_2 = BatchNorm(size=[4, 4, 512])
l8_3 = Convolution2D(input_sizes=[batch_size, 4, 4, 512], filter_sizes=[1, 1, 512, 512], init=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=args.bias, name="conv3", load=weights_conv, train=train_conv)
