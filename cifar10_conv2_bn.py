...
l1 = BatchNorm(input_size=[batch_size, 32, 32, 96], name='conv1_bn')
...
l4 = BatchNorm(input_size=[batch_size, 16, 16, 128], name='conv2_bn')
l5 = MaxPool(size=[batch_size, 16, 16, 128], ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding="SAME")

l6 = ConvToFullyConnected(shape=[8, 8, 128])

l7 = FullyConnected(size=[8*8*128, 10], num_classes=10, init_weights=args.init, alpha=learning_rate, activation=Linear(), bias=args.bias, last_layer=True, name='fc1', load=weights_fc, train=train_fc)
