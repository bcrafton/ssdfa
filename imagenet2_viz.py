...
weights_fc=None
if args.dfa:
    weights_conv='imagenet_dfa1.npy'
else:
    weights_conv='imagenet_bp1.npy'
...
l3 = Convolution(input_sizes=[batch_size, 27, 27, 96], filter_sizes=[5, 5, 96, 256], num_classes=num_classes, init_filters=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=learning_rate, activation=Relu(), bias=1., last_layer=False, name="conv2", load=None, train=True)
...
'''
l13 = ConvToFullyConnected(shape=[13, 13, 256])
'''
...
'''
l20 = FullyConnected(size=[13*13*256, num_classes], num_classes=num_classes, init_weights=args.init, alpha=learning_rate, activation=Linear(), bias=args.bias, last_layer=True, l2=args.l2, name="fc3", load=weights_fc, train=train_conv)

###############################################################

model = Model(layers=[l0, l1, l3, l4, l5, l13, l20])
