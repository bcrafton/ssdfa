...
d = conv1d_grad(input_shape=(batch_size, time_size, input_size), filter_shape=(filter_size, input_size), x=x, d=z)
...
[_z, _d] = sess.run([z, d], feed_dict={})
print (np.shape(_z), np.shape(_d))
